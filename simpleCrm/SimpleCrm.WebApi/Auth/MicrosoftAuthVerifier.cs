...
namespace SimpleCrm.WebApi.Auth
{
    ...
    {
        // TODO: You should have MicrosoftAuthSettings from the OAuth assignment
        // if you named yours different, that's fine, just use it.
        ...
        public async Task<MicrosoftUserProfile> AcquireUser(string token)
        {
            try
            {
                ...
                // some of the code for MicrosoftAuthVerifier.AquireUser(...)
